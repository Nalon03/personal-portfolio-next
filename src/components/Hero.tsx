...
const Hero: React.FC = () => {
  ...
  return (
    <section className="hero-section relative min-h-screen flex flex-col">
      <AnimatedBackground />
      ...
      <div className="hero-content relative z-10 flex items-center justify-center h-full my-24">
        ...
        >
          ...
          >
            <motion.button
              className="hero-btn-primary px-5 py-2 bg-transparent border border-cyan-400/80 text-cyan-400 text-xs font-medium rounded-md hover:bg-cyan-400/20 hover:border-cyan-400 hover:text-cyan-400 transition-all duration-300 font-sans"
            ...
            <motion.button
              className="hero-btn-secondary px-5 py-2 bg-transparent border border-white/60 text-white text-xs font-medium rounded-md hover:bg-white/10 hover:border-white hover:text-white transition-all duration-300 font-sans"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
